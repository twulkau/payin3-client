...
use PayIn3\Client\HeaderSelector;
...
class PartnerRegistrationCheckApi
{
     ...
     *
     * @param  \PayIn3\Client\Model\PartnerRegistrationCheckRequestV2Model $v2_model v2_model (required)
     *
     * @throws \PayIn3\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \PayIn3\Client\Model\RegistrationCheckResultViewModel
     */
     ...
     *
     * @param  \PayIn3\Client\Model\PartnerRegistrationCheckRequestV2Model $v2_model (required)
     *
     * @throws \PayIn3\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \PayIn3\Client\Model\RegistrationCheckResultViewModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function partnerRegistrationCheckV2PostWithHttpInfo($v2_model)
    {
        $returnType = '\PayIn3\Client\Model\RegistrationCheckResultViewModel';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\PayIn3\Client\Model\RegistrationCheckResultViewModel',
